...
# /home/aszitao/test(todo)/model__A_e15.tar 85896 /home/aszitao/pre7/model__N_e19.tar
...
def main_train(model, stage):
    ...
    testing_rgb, testing_lidar, testing_mask = testing_rgb.to(DEVICE), testing_lidar.to(DEVICE), testing_mask.to(DEVICE)#,yuyi.to(DEVICE)################################
    ...
    loader = {'train': get_loader('train', num_data=args.num_data), \
              'val': get_loader('val', shuffle=False, num_data=6852)}#, shuffle=False 6852  600
    ##读入数据 训练集中的数据集 一个
